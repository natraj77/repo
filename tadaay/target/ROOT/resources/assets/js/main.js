(function ($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({siteLogo: "<a href='/' class='logo-mobile-menu logo-text'><img src='../resources/images/logo.png' width='100px'></a>"});
    //$('nav#dropdown').meanmenu({siteLogo: "<a href='#' class='logo-mobile-menu logo-text'>'<img src="/'/Polyglot/resources/images/logo.png'/"/>'</a>"});
    ...
    $('#countdown').countdown('2018/01/01', function (e) {
        ...
        $(this).html(e.strftime("<div class='countdown-section'><h3>%D</h3> <p>Days%!D</p> </div><div class='countdown-section'><h3>%H</h3> <p>Hours%!H</p> </div><div class='countdown-section'><h3>%M</h3> <p>Minutes%!M</p> </div><div class='countdown-section'><h3>%S</h3> <p>Seconds%!S</p> </div>"));
...
//        $('#login-form').hide();
    ...
    $("#share").jsSocials({
        shares: ["facebook","googleplus", "linkedin","twitter"]
    });
...
t.parentsUntil('nav', 'li').addClass('active'); //set the active class to all the li parents of the anchor element
    ...
    /*Hello bar */
    setTimeout(function () {
	    $('#sayHello').show().addClass('animated fadeInUp');}, 3000
	);
