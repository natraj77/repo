...
$('#adminCourseDataForm').validate({
    ...
    messages: {
        ...
        isActive: {
        	...
        	required: "News Identifier  is required"
        }
    },
...
function enableDisableButtons() {
	...
	function saveUpdateAdminCourse() {
	    if($('#id').val()!=''){
	    	alert('Editing News '+$('#id').val());
	    }else{
	    	alert('Saving new News');
	    }
	    ...
	    $.ajax({
	        ...
	        type: 'POST',
	        url: '../saveUpdateNewsData?id=' + $('#id').val(),
	        dataType: 'json',
