...
<script src="../resources/assets/js/invite.js" type="text/javascript"></script>
            ...
            <div id="inviteErrMsg"></div>
	               ...
	               <div id="inviteDiv">
		            <div class="after-add-more">
			      		<div class="col-sm-12 row form-group">	
						 	...
						 	<div class="col-sm-2">
			      	 			<select class="form-control" id="role" name="role">
									...
									<option value="T">Trainers</option>
									<option value="P">Institutes</option>
					 ...
					 <div class="copy-fields hide form-group">
				          <div class="remove-invites col-sm-12 row form-group">
					           <div class="col-sm-2 no-padding">
					      	 			<input type="text" class="form-control" id="copyfirstName" name="copyfirstName" placeholder="First Name" autocomplete="off">
								 	</div>
								 	<div class="col-sm-2">
					      	 			<input type="text" class="form-control" id="copylastName" name="copylastName" placeholder="Last Name" autocomplete="off">
								 	</div>
								 	<div class="col-sm-2">
					      	 			<input type="text" class="form-control" id="copymobile" name="copymobile" placeholder="Mobile" autocomplete="off">
								 	</div>
								 	<div class="col-sm-3">
					      	 			<input type="email" class="form-control" id="copyemail" name="copyemail" placeholder="Email" autocomplete="off">
								 	</div>
								 	<div class="col-sm-2">
					      	 			<select class="form-control" id="copyrole" name="copyrole">
											<option value="U">Student</option>
											<option value="T">Trainers</option>
											<option value="P">Institutes</option>
											<option value="R">Recruiter</option>
			        ...
			        <div class="text-right">
				    		<button type="submit" class="btn btn-info bg-teal-400" onclick="validateForm();">Invite</button>
				   	</div>
			        </form>
			        <div>
		              <h5>Pending Invites</h5>
			         <div>           
						<table id="invitesDataTable" class="display table table-striped table-bordered table-hover" style="width:100%;">
						   <thead>
							<tr>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" id="demoDataForm" name="demoDataForm">
        <div class="modal-body">
          ...
          <input type="hidden" name="inviteObj" id="inviteObj" />
        </div>
...
<!-- Import Invites -->
<div class="modal fade" id="inviteData" tabindex="-1" role="dialog" aria-labelledby="inviteData">
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					        <h4 class="modal-title" id="inviteDataLabel">Upload Invite Data</h4>
					      </div>
					      <form class="form-horizontal" id="inviteDataForm" name="inviteDataForm">
					        <div class="modal-body">
					        <!-- <div class="form-group">
					         ...
					         <div class="form-group">
					            <div class="col-sm-12">
							        <input id="file-invites" name="file" type="file" multiple="multiple">							       
					             </div>
					          </div>
					        </div>
					      </form>
					      <div class="modal-footer">
							<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
							<button type="submit" class="btn btn-primary" onclick="saveExcelInvites();">Import</button>
							<img id="loading" style="display:none" src="<%=request.getContextPath()%>/resources/images/course-preload.gif" alt="tadaay">
						</div>
					    </div>
					  </div>		              
		            </div>
...
<script type="text/javascript">
	...
	//here first get the contents of the div with name class copy-fields and add it to after "after-add-more" div class.
      $(".add-more").click(function(){
    	  ...
    	  html = html.replace('copyrole','copyrole'+i);
