...
<html class="no-js" lang="en-US">
  ...
  <div class="container-fluid">
  	<div class="login-logo-area hidden-xs">
	    ...
	    <div class="row">
	      <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 left-side recruiter-bg">
	        <div class="signup-text-block">
				 <img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/r.png" alt="courses">	          
	        </div>
	      </div>
				           ...
				           <div class="col-sm-7 col-lg-7 col-md-7 radio">
				             ...
				             <label for="partnerType" class="radio-inline">
				              ...
				              <label for="recruiterType">
				               <input type="radio" name="userType"  id="recruiterType"  checked value="R" > Recruiter
				             </label>
				           </div>
				         </div>
					      <div class="row">
