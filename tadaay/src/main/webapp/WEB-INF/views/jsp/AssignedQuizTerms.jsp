            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12">
                <h3 class="sidebar-title">Description</h3>
                 <p>${quizDesc}</p>
                <h3 class="sidebar-title">Guide Lines</h3>
      ...
      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
        <div class="sidebar">
            ...
            <div class="sidebar-box-inner">
              <h3 class="sidebar-title">Quiz Details</h3>
              <div class="sidebar-course-price quiz-sections">
              	<h4>Sections</h4>
              	<c:forEach var="temp" items="${categories}">
              	  <p> <c:out value="${temp}"></c:out></p>
              	</c:forEach>
              </div>
              <div class="sidebar-course-price">
                <p>Number Of Questions <span>${noOfQuestions}</span></p>
                <p>Duration <span>${duration} Minutes</span></p>
                <p>Negative Marks <span>${negitiveMarks}</span></p>
                <a href="javascript:void();" class="enroll-btn" data-toggle="modal" data-target="#myModal">Start Quiz</a>
              </div>
            </div>
          </div>
        </div>
