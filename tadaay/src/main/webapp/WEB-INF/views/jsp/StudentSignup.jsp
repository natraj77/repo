...
<html class="no-js" lang="en-US">
  ...
  <div class="container-fluid">
	    ...
	    <div class="row">
	      <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 left-side signup-left-side student-bg">
	        <div class="signup-text-block">
	         	<img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/student.png" alt="courses">
	        </div>
	      </div>
                        ...
                        <div class="row" style="opacity:0;">
                          ...
                          <span class="signup-input signup-input-mrg input-block email-error">
					       ...
					       <span class="password-note">Note:(Password should be alphanumeric with special character)</span>
					        ...
					        <div class="cta">
					          <button class="btn btn-primary btn1-bg">
					            Sign-Up Now
					          </button>
					        </div>
						      <div class="newto-signup text-center">
					         	Do you have an Existing Account go to <a href="<%=request.getContextPath()%>/Login">Login</a>
					         	</div>
                        </form>
                        <!-- thank you -->
