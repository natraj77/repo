...
<script src="../resources/assets/js/studentdemos.js" type="text/javascript"></script> 
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
			...
			<table id="studentDemosTable" class="display table table-striped table-bordered table-hover">
			   <thead>
				<tr>
					...
					<th><span>Demo Date and Time</span></th>
