	    ...
	    <div class="row">
	      <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 left-side trainer-bg">
	        <div class="signup-text-block">
				 <img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/training-institute.png" alt="courses">	         
	        </div>
	      </div>
                        ...
                        <div class="row" style="opacity:0;">
				           ...
				           <div class="col-sm-7 col-lg-7 col-md-7 radio">
				             <label for="userType" class="radio-inline">
				               ...
				               <input type="radio" name="userType"  id="partnerType" checked value="P" > Training Institute
				             </label>
				              <label for="trainerType" class="radio-inline">
				               <input type="radio" name="userType"  id="trainerType"  value="T" > Trainer
				             </label>
				         	...
				         	<span class="signup-input signup-input-mrg input-block fname-error">
					          <input class="input_field input_field-name" type="text" id="instName" name="instName" />
					          <label class="input_label input_label-name border-color" for="instName">
					            <span class="input_label-content label-name">Institute Name</span>
					          </label>
					        </span>
